  ...
  return (
    <div>
      <div className="flex items-center gap-3 mb-6">
        <Link href="/staff/payments" className="text-gray-400 hover:text-gray-600">
          <ArrowLeft size={20} />
        </Link>
      ...
      <div className="card mb-4">
        <div className="flex items-center justify-between mb-4">
          <div>
            ...
            <p className="text-sm text-gray-500">
              {payment.cleaning_companies?.name}
            </p>
          </div>
          ...
          <table className="w-full text-sm">
            ...
            <tfoot>
              <tr className="border-t border-gray-200">
                <td colSpan={2} className="py-2 font-medium">小計</td>
        ...
        {expenseTotal > 0 && (
          <>
            ...
            <p className="text-sm text-right mb-2">{formatCurrency(expenseTotal)}</p>
          </>
        )}
